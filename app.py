...
# 安全引入 scikit-learnimport streamlit as st
...
u_score_thresh = st.sidebar.number_input("大學：總平均分門檻", value=float(st.session_state['u_score_val']))
u_chi_thresh = st.sidebar.number_input("大學：中文分數門檻", value=float(st.session_state['u_chi_val']))
u_eng_thresh = st.sidebar.number_input("大學：英文分數門檻", value=float(st.session_state['u_eng_val']))
u_math_thresh = st.sidebar.number_input("大學：數學分數門檻", value=float(st.session_state['u_math_val']))
u_cs_thresh = st.sidebar.number_input("大學：公社科分數門檻", value=float(st.session_state['u_cs_val']))
